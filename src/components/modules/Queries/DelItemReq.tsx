...
const DelItemReq = () => {
  ...
  useEffect(() => {
    const getdata = async () => {
      const res = await olfService.get('/restraunts', {params: {change_type:3}});
  ...
  const { 
    ...
    queryFn: () => {
      const params: any = {change_type:3};
      if (isVegOnly) {
                  ...
                  <Table>
                    <TableHeader className="bg-green-100">
                      <TableRow className="hover:bg-green-100/80">
                        ...
                        <TableHead className="font-bold text-green-800 border border-green-200">DELETE</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {paginatedMenuItems.length > 0 ? (  
                        paginatedMenuItems.map((item: MenuItem) => (
                          ...
                          >
                            ...
                            <TableCell className="border border-green-200">
                             <Button className='bg-red-400' onClick={(e) => handleDeleteMenuItem(item.item_id, e)}>Delete</Button>
